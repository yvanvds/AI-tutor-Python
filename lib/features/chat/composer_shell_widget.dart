...
/// Shared positioned/blurred container used by all composer state widgets.
/// Handles safe-area padding, backdrop filter, and height measurement.
...
class _ComposerShellState extends State<ComposerShell> {
  ...
  @override
  void didUpdateWidget(covariant ComposerShell oldWidget) {
