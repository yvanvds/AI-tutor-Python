...
class LoBeliefsService {
  ...
  /// progress export in the Options panel (#32) and by the conductor: once
  /// per session for the warm-up review selection (#102, #194,
  /// CONDUCTOR_POLICY §1.5) and once per open recheck slot (#187, §2.6) —
  /// a single-partition query the size of the curriculum.
