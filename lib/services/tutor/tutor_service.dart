...
class TutorService extends Notifier<TutorState> {
  ...
  void _recordResponse(ChatResponse response) {
    ...
    if (isQuestion) _bankQuestion(response);
  }
  ...
  String _configuredModel() {
    ...
    final configured = ref.exists(globalConfigServiceProvider)
        ? ref.read(globalConfigServiceProvider)?.model
        : null;
